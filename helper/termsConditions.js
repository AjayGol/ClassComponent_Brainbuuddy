...
// privacyPolicy = (strLocale) => {
//     return strLocale("TermsAndCondition.privacyPolicy") }
//
// subscription = (strLocale) => {
//     return strLocale("TermsAndCondition.subscription") }
//
// termsOfUse  = (strLocale) => {
//     return strLocale("TermsAndCondition.termsOfUse") }
//
// subscriptionAndroid = (strLocale) => {
//     return strLocale("TermsAndCondition.subscriptionAndroid") }
...
const subscription = "App Using Auto-Renewing Subscription.\nYou can manage/cancel your subscription any time in your phone setting. " +
    "If you facing any issue related subscription please send mail in support section in setting.\n\n" +
    "App only using with subscription. You have full access app with after subscription..\n\n" +
    "subscription only start after 7 day free trial period.\n\nMonthly subscription is prices at $4.99 per month.\n\n" +
    "Payment will be charged using iTunes account at confirmation of purchase.\n\nApp using Auto-Renewing subscription " +
    "so this will be charged renewal within 24 hours prior to the end of the current period, and identify the cost of the renewal." +
    "\n\nNo cancellation of the current subscription is allowed during the active subscription period.\n\n" +
    "Apple declare Apple Play Store Matrix for price define equivalent of the subscription price in $USD.\n\n " +
    "You can also available terms & condition and privacy policy with web \nhttps://www.beefupapp.com/privacy\b" +
    "https://www.beefupapp.com/terms\n\nLet up know if you have any query using support beefupapp@gmail.com";
...
const subscriptionAndroid = "App Using Auto-Renewing Subscription.\nYou can manage/cancel your subscription any time in your phone setting. " +
    "If you facing any issue related subscription please send mail in support section in setting.\n\nApp only using with subscription. " +
    "You have full access app with after subscription..\n\nsubscription only start after 7 day free trial period.\n\n" +
    "Monthly subscription is prices at $2.99 per month.\n\nPayment will be charged using Google Play account at confirmation of purchase.\n\n" +
    "App using Auto-Renewing subscription so this will be charged renewal within 24 hours prior to the end of the current period, " +
    "and identify the cost of the renewal.\n\nNo cancellation of the current subscription is allowed during the active subscription period." +
    "\n\nGoogle declare Google Play Store Matrix for price define equivalent of the subscription price in $USD.\n\n " +
    "You can also available terms & condition and privacy policy with web \nhttps://www.beefupapp.com/privacy\b" +
    "https://www.beefupapp.com/terms\n\nLet up know if you have any query using support beefupapp@gmail.com"
