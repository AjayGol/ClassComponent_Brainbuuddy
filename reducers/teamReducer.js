import {
    ...
    GLOBAL_STATISCTIC, SEEN_USER_EVENTS, EVENT_BADGE_COUNT, START_EVENT_VIEWS, TEAM_LIST, TEAM__LIST_PAGINATION,
    INVITE_LIST, INVITE_LIST_PAGINATION, TEAM_LIST_SORT_TYPE, TEAM_TODAY_MOTIVATION_DONE,
    TEAM_CHAT_GET_MESSAGE
} from '../actions/types'
...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case TEAM__LIST_PAGINATION: {
            return {
                ...state,
                teamListPagination:action.payload
            };
        }
        case TEAM_LIST_SORT_TYPE: {
            return {
                ...state,
                teamListSortType:action.payload
            };
        }
        case INVITE_LIST: {
            return {
        ...
        case INVITE_LIST_PAGINATION: {
            return {
                ...state,
                inviteDataPagination:action.payload
            };
        }
        case TEAM_TODAY_MOTIVATION_DONE: {
            return {
                ...state,
                teamMotivationList: action.payload
            };
        }
        case TEAM_CHAT_GET_MESSAGE: {
            return {
                ...state,
                getMessageListener:action.payload
            };
        }
        default:
            return state;
