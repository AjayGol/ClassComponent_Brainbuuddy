...
import APIConstanct from '../../services/apiConstant';
import {LEVEL_NUMBER} from "../../actions/types";
const keys = APIConstanct.metadataKeys;
...
let selectedOptionalExercise= [
    ...
    {title: 'Kegel Exercises', isSelected: true, pageName: 'kegalsActivity'},
