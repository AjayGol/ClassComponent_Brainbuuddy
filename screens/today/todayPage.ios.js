...
import {
    ...
    manageNotificationAward, sendNotificationRemote, themeUpdate,
    updaterevenuecatID
...
import {
    checkForValidation, loadAllProducts, restoreAllData,
    checkForValidationNew, loadAllProductsNew, restoreAllDataNew, purchaseAppNew
} from '../../helper/inAppPurchase';
...
let positionTutorialSetting = {
    x: Constant.screenWidth - 63,
    y: (Constant.screenHeight * 0.035),
    width: 50,
    height: 20
};

let positionTutorialTodayMeditation = {
    x: 0,
    y: 0,
    width: 0,
    height: 0
...
class TodayPage extends React.Component {
    ...
    constructor(props) {
        ...
        //     //     {nextPage: "rootTabNavigation", isRestore: true});
        // },5000)
        // crashlytics().log('User signed in.');


        marginCheck = this.props.safeAreaInsetsData.top + 10;
        if (this.props.safeAreaInsetsData.top === 0) {
            marginCheck = 10;
    ...
    UNSAFE_componentWillMount() {
        ...
        this.props.navigation.addListener('focus', () => {
            if (this.state.checkUpFlag && this.state.checkUpFlag === 2 && this.state.checkupTimeMessage && !this.state.checkupTimeMessage.includes("redo")) {
                StatusBar.setBarStyle('light-content', false);
            } else if (this.state.relapseCheckup !== undefined && this.state.relapseCheckup === true) {
                StatusBar.setBarStyle('light-content', false);
            } else if (this.state.checkupTimeMessage && this.state.checkupTimeMessage.includes("redo")) {
                StatusBar.setBarStyle('light-content', false);
            }
    ...
    sendMain = () => {
        ...
        RNSmtpMailer.sendMail({
            ...
            username: "beefupapp@gmail.com",
            password: "ketan123@",
            from: "beefupapp@gmail.com",
            recipients: "vkubhada@gmail.com",
            ...
            .then(success => console.log('2222222'))
            .catch(err => console.log('33333333' + err));
    }
    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem('isNewOpen').then((isNewOpen) => {
            ...
            if (isNewOpen) {
                if (isNewOpen === "true") {
                    // if (!__DEV__) {
                    if (this.props.userEmail !== Constant.testUser && this.props.userEmail !== Constant.testUser2) {
        ...
        // check this is proper work
        this.hideAlltodaysPopup();
        // setTimeout(() => {
        //     this.props.removeSafeArea();
        //     this.hideAlltodaysPopup();
        //     this.props.navigation.navigate("getStarted2", {
        //         nextPage: "rootTabNavigation",
        //         isRestore: true
        //     });
        //
        //     Alert.alert("Please verify your subscription",
        //         "Verify your subscription and continue using app.",
        //         [
        //             {
        //                 text: strLocale('Continue'),
        //                 onPress: () => {
        //                     // this.props.removeSafeArea();
        //                     // this.hideAlltodaysPopup();
        //                     // this.props.navigation.navigate("getStarted2", {
        ...
        // alert(global.isOpenNotificationTodayUpdate)
    }
    ...
    hideAlltodaysPopup = () => {
        ...
        this.props.manageUpdateForCalendar({
            isShow: false,
            detail: '',
        })
        this.props.manageMissedCheckup({
            isShow: false,
            detail: '',
        });
        // isPopupInProcess = false;
                ...
                if (nextProps.last_checkup_at === yesterdayDate
                    ...
                    if (nextProps.last_checkup_at === dayBeforeYesterdayDate && !this.state.isAskYesterdayCheckup) {
                        if (find(nextProps.p_array.data, {occurred_at: yesterdayDate}) === undefined
                            ...
                            if (!this.state.isAskYesterdayCheckup) {
                                this.props.manageMissedCheckup({
                                        isShow: true,
                                        detail: {
                                            title: strLocale("today.You missed your checkup yesterday"),
                                            buttonTitle: strLocale("today.Checkup Now"),
                                        }
                                    }
                                );
                                this.setState({
                        ...
                        if (find(nextProps.p_array.data, {occurred_at: todayDate}) === undefined &&
                            ...
                            if (!this.state.isAskForUpdateCalendar) {
                                this.props.manageUpdateForCalendar({
                                        isShow: true,
                                        detail: {
                                            title: strLocale("today.Take your previous days checkup"),
                                            buttonTitle: strLocale("today.Checkup Now"),
                                            buttonTitle2: strLocale("today.Update Calendar")
                                        }
                                    }
                                );
                                this.setState({
    ...
    setToDOActivity = () => {
        try {
            ...
            // let todayDate = moment().format("YYYY-MM-DD");
            // if (this.props.registered_at === todayDate) {
            //     todoActivityArray.push(allOptionalExercies.visualizationActivity)
            // } else {
            //     switch (today) {
            //         case 1 :
            //             isAudioActivity = true;
    ...
    setCheckupView = () => {
        ...
        try {
            ...
            let hourHere = settingNotifications[0].hours || settingNotifications[0].selectedTime;
    ...
    find_dimesions(layout, type) {
        // const {x, y, width, height} = layout;
        //
        // if (type === "setting") {
        //     // positionTutorialSetting.y = positionTutorialSetting.y - this.props.safeAreaInsetsDefault.top
        //     // positionTutorialSetting = layout;
        // }else if (type === "menu") {
        //     alert(x)
        //     positionTutorialTodayMeditation = {
        //         x: x,
        //         y: y,
        //         width: width,
        //         height: (height/2)
        //     }
        // }
        // // this.props.topProgressHeigh(height);
    }
    ...
    onCheckupCardClicked = (type) => {
        ...
        try {
            ...
            let checkupHour = this.props.checkupTime;
            // if (currentHour < checkupHour) {
            let value = this.props.last_checkup_at;
            let obj = find(this.props.p_array.data || [], function (o) {
                return o.occurred_at === value
            })
            if (this.props.last_checkup_at === todayDate && obj !== undefined) {
                this.props.manageCheckupPopup({
                    isShow: true,
                    checkUpDetail: {
                    ...
                    this.props.navigation.navigate(page,
                        {
                            ...
                            improve: obj.improve || [],
                            isOptional: isLast,
                            isLast: this.manageTodayMotivation(page),
        ...
        try {
            switch (page) {
                case 'calendar':
                    ...
                    break;
                case 'missedcalendar':
                    if (isMornigRoutine.title === "Checkup Now") {
                        this.props.navigation.navigate("missedCheckUp", {
                            isYesterday: false,
                            isFromToday: true,
                            scrollToTopToday: this.scrollToTopToday,
                        ...
                        this.props.navigation.navigate("editPornCalendar",
    ...
    manageTodayMotivation = (page) => {
        ...
        let morningRoutine = this.props.morningRoutine;
        if (morningRoutine.length === completedMorningRoutine.length + 1) {
            let obj = find(this.props.completedMorningRoutine.routineActivities, {pageName: page});
            if (obj === undefined) {
                return true
            } else {
                return false
    ...
    renderTodayList = () => {
        ...
        return (
            <View onLayout={(event) => {
                this.find_dimesions(event.nativeEvent.layout, "menu")
            }}
                  style={{width: '90%', left: '5%', marginBottom: -15}}>
    ...
    render() {
        ...
        const topHeader = this.state.scrollY.interpolate({
            inputRange: [0, 40],
            outputRange: [0, 1],
            extrapolate: 'clamp'
        });
        ...
        let checkUpType = 0;
        if (this.props.appTheme === 'DARK') {
            if (this.props.visibleTab === 'today') {
                StatusBar.setBarStyle('light-content', false);
            }
        } else {
            if (this.props.visibleTab === 'today') {
        ...
        if (this.state.checkUpFlag === 2 && !this.state.checkupTimeMessage.includes("redo")) {
            ...
            try {
                ...
                //     dict.desc = `Current scheduled time for checkup is ${settingNotifications[0].selectedTime}`;
                // }
                ...
                <Animatable.View style={{flex: 1}} ref="mainView">
                    <LinearGradient colors={['white', 'white']}
                        ...
                        <Animated.ScrollView
                                    ...
                                    [{
                                        nativeEvent: {
                                            contentOffset: {
                                                y: y =>
                                                    Animated.block([
                                                        Animated.set(this.state.scrollY, y),
                                                        Animated.call(
                                                            [y],
                                                            ([offsetx, event]) => {
                                                                contentOffset = offsetx;
                                                            }
                                                        )
                                                    ])
                                            }
                            ...
                            <View onLayout={(event) => {
                                this.find_dimesions(event.nativeEvent.layout, "setting")
                            }}
                                  style={{
                                ...
                                <Image source={{uri: 'new_icon_home_topright'}}
                                       style={{
                                           height: Constant.screenWidth * 0.47,
                                           width: (Constant.screenWidth * 0.47) * 0.731
                                       }}/>
                        ...
                        <Animated.View pointerEvents={"none"}
                            ...
                            <View
                                style={[{
                                    backgroundColor: checkUpType === 3 && '#6DA32F' || checkUpType === 2 && '#FE5F75' || checkUpType === 1 && '#56ab2f' || appColor.appBackground,
                                    height: this.props.safeAreaInsetsData.top + 20,
                                    paddingTop: 0,
                                }]}>
                            </View>
                        </Animated.View>
    ...
    checkForSubscription = () => {
        ...
        if (this.props.isConnected) {
            if (!this.props.subscriptionInProcess) {
                ...
                loadAllProductsNew().then(res => {
                    restoreAllDataNew()
                        .then(res => {
                            checkForValidationNew()
                                .then(res => {
                                    //Valid subscription
                                ...
                                if (err === "Expired") {
                                    ...
                                    showThemeAlert({
                                        title: "BeefUp",
                                        message: "Your subscription not verify. Please retry to subscription for continue using BeefUp",
                                        leftBtn: strLocale("OK"),
                                        leftPress: (i) => {
                                            // this.hideAlltodaysPopup();
                                            // this.props.navigation.navigate("getStarted", {
                                ...
                                } else if (err === "Sandbox receipt sent to Production environment") {
                                    checkForValidationNew("sandbox")
                                        .then(res => {
                                            AsyncStorage.setItem('isSubscribe', "true");
                                            this.props.setSubscriptionInProcess(false);
                                        }).catch(err => {
            ...
            if (this.props.isConnected) {
                if (!this.props.subscriptionInProcess) {
                    ...
                    if (typeof purchaserInfo.entitlements.active["Full Acess"] !== "undefined") {
                        ...
                        this.failToSubscriptionChecking();
                        // setTimeout(() => {
    ...
    failToSubscriptionChecking = () => {
        ...
        showThemeAlert({
            title: "BeefUp",
            message: "Your subscription is expired now. Please renew subscription for continue using BeefUp",
            leftBtn: strLocale("OK"),
            leftPress: (i) => {
            }
        });
